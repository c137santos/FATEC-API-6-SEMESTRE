...
async def test_post_batch_retorna_202_com_batch_id(client, mock_batch_db):
    ...
    with patch('backend.routes.pipeline.task_run_batch.delay'):
...
@pytest.mark.asyncio
async def test_post_batch_retorna_409_quando_lote_em_execucao(
    client, mock_batch_db
):
...
@pytest.mark.asyncio
async def test_post_batch_documento_criado_com_is_running_e_params(
    client, mock_batch_db
):
...
@pytest.mark.asyncio
async def test_get_batch_status_retorna_200_lote_encerrado(
    client, mock_batch_db
):
...
@pytest.mark.asyncio
async def test_get_batch_status_retorna_200_lote_em_execucao(
    client, mock_batch_db
):
