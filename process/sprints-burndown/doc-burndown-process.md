## Exemplificação da velocidade de entrega realizada pela equipe de desenvolvimento.
...
* Tarefa planejada da sprint: recebe estimativa inicial em horas na Planning sem adições e ajustes posteriores.

* Desenvolvedor: registra apenas as horas efetivamente trabalhadas.

* Desenvolvedor: não altera a estimativa / controle de horas da task.

* Só deve haver lançamento de horas em tarefas que já possuem hora definida.

* Tarefa concluída: deve ser movida corretamente até a coluna final do fluxo.

* Tarefas técnicas não planejadas: fazem parte do escopo, mas não recebem expectativa de horas para esse controle.

* Hotfixes: também fazem parte do escopo e não recebem expectativa de horas.

* Qualquer dúvida sobre horas, exceções ou necessidade de ajuste: acionar o Scrum Master.

* Tarefas podem ser criadas livremente durante a Sprint (sem adição de controle de horas).